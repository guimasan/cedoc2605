				...
				<div class="page-header-hightlights d-flex flex-wrap">
					...
					<div class="col-12 col-xl-2 col-lg-3 d-flex flex-wrap page-header-share">
						<div class="page-header-icons">
							...
							<a href="https://www.facebook.com/sharer.php?u=<?php echo get_term_link((int) $current_term->get_id()); ?>" title="<?php esc_attr_e('Share this on facebook', 'tainacan-interface') ?>" class="share-link" target="_blank">
							...
							<a href="https://twitter.com/share?url=<?php echo get_term_link((int) $current_term->get_id()); ?>&amp;text=<?php echo $current_taxonomy->labels->name . ':' . $current_term->get_name(); ?><?php echo $via; ?>" target="_blank" title="<?php esc_attr_e('Share this on twitter', 'tainacan-interface') ?>" class="share-link">
